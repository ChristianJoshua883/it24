...
// Get the city input and search button elements
...
function getWeatherData(city) {
  ...
  fetch(url)
    ...
    .then(data => {
      ...
      document.getElementById("weather").innerHTML = `Conditions: ${data.weather[0].description}`;
      document.getElementById("temperature").innerHTML = `Temperature: ${data.main.temp}K`;
    })
